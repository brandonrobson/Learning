...
public class BallScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Vector2 newVelocity = new Vector2(body.velocity.x, (body.velocity.y * -1));     // Create temporary variable to only change Y values.
            body.velocity = newVelocity;                                                    // Apply the new velocity, negating the Y value and
                                                                                            // thus changing the direction of the ball.
        }
        ...
        {
            body.Sleep();   // Rigidbody is disabled
        }
